...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-200 dark:bg-gray-800">
        <a href="{{route('dashboard')}}">
            <div class="flex mb-4">
                <img src="{{asset('images/logo.jpeg')}}" class="rounded-full h-6 me-3 sm:h-7" alt="WillJobsPro Logo" />
                <span class="self-center text-[#11364C] text-xl font-semibold whitespace-nowrap dark:text-white">WillJobsPro</span>
            </div>
        </a>
...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg ml-44 bg-gray-200">
    <h1 class="text-2xl ml-44 text-[#11364C]">Job Posts</h1>
